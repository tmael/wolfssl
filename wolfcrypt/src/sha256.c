...
/*!
    ...
    \brief This local function performs the main hash computation

    \return 0 Success

    \param sha256 Pointer to the Sha256 structure
...
/*!
    ...
    \brief This local function initializes SHA256.

    \return 0 Returned upon successfully initializing
    \return BAD_FUNC_ARG error returned if sha256 is null

    \param sha256 pointer to the sha256 structure to use for hash calculation
...
/*!
    ...
    \brief This function initializes SHA256. It calls InitSha256 function.
...
/*!
    ...
    \brief This function updates the length of the input message.

    \return none

    \param sha256 pointer to the sha256 structure to use for hash calculation
    \param len length of the processed message
*/
...
/*!
    ...
    \brief This local function can be called to continually hash the provided byte
    array of length len.
...
/*!
    ...
    \param sha256 Pointer to the Sha256 structure source
    \param sha256 Pointer to the Sha256 structure destination
...
/*!
    ...
    \brief Finalizes hashing of data.
